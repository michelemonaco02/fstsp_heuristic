...
def analyze_vdrpmdpc_simulation_all_pairs():
    # Lista di file da analizzare, includendo tutti gli scenari Urban e Semi-Urban
    files = {
        20: {
        ...
        40: {
            "van": ["Van_Urban_40.xlsx", "Van_Semi-Urban_40.xlsx"],
            "drone": ["Drone_Urban_40.xlsx", "Drone_Semi-Urban_40.xlsx"]
        },
        60: {
            "van": ["Van_Urban_60.xlsx", "Van_Semi-Urban_60.xlsx"],
            "drone": ["Drone_Urban_60.xlsx", "Drone_Semi-Urban_60.xlsx"]
        }
    }
    ...
    # Testa tutte le coppie di file, numero di clienti e velocità del drone
    for num_clients in num_clients_list:
        ...
        # Cicla su ogni combinazione di file Van e Drone
        for van_file in files[num_clients]["van"]:
            for uav_file in files[num_clients]["drone"]:
                if van_file and uav_file:
                    ...
                    for drone_speed in drone_speeds:
                        ...
                        print(f"\nTesting with {num_clients} clients, van file: {van_file}, drone file: {uav_file}, truck speed: {truck_speed} km/h and drone speed: {drone_speed} km/h")
    ...
    df_savings = df_results[['num_clients', 'van_file', 'uav_file', 'drone_speed', 'time_savings_percent']]
    print(df_savings)

if __name__ == "__main__":
    analyze_vdrpmdpc_simulation_all_pairs()
