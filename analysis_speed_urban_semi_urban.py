...
def analyze_vdrpmdpc_simulation_all_pairs():
                ...
                for uav_file in drone_files:
                    if van_file and uav_file:
                        ...
                        for drone_speed in drone_speeds:
                            ...
                            print(f"\nTesting with {num_clients} clients, scenario: {scenario_type}, van file: {van_file}, drone file: {uav_file}, truck speed: {truck_speed} km/h and drone speed: {drone_speed} km/h")
    ...
    df_savings = df_results[['num_clients', 'scenario_type', 'van_file', 'uav_file', 'drone_speed', 'time_savings_percent']]
    print(df_savings)
